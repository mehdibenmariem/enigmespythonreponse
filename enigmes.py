...
def repondre(niv, essais, pt, ar):
    ...
    match rep :
        case rep : 
            rep in rep_enigme['rep e%s' % e] or rep == 'triche'
            saut()
            print("Bonne réponse !!!!")
            ct = 0
            points = points + pt
            ...
            commande.help()
            rep == '/indice'
            match indice_fournis :
                case indice_fournis :
                    indice_fournis in (0, 1)
                    saut()
                    print(idi['i %s' % e])
        ...
        match cmd :
            case cmd :
                ...
                while cm == False:
                    ...
                    match cmd :
                        case cmd :
                            if cmd in ['/help','/stat','/leave','/enigme','/rules','/config','/shop','/reset']:
                                cm =True
                            cmd == '/help'
                            saut()
                            print("/enigme : tirer une énigme au hasard\n/stat : voir ses statistiques\n/leave : quitter la partie(attention, si vous quitter, rien ne sera enregistré !)\n/rules : voir les règles du jeu")
